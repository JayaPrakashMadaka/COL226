000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\017\000\069\000\018\000\035\000\000\000\
\\000\000\
\\000\000\
\\011\000\071\000\012\000\070\000\013\000\026\000\014\000\025\000\
\\015\000\024\000\016\000\037\000\017\000\036\000\018\000\035\000\000\000\
\\000\000\
\\000\000\
\\010\000\075\000\011\000\074\000\012\000\073\000\013\000\026\000\
...
\\000\000\
\\000\000\
\\014\000\081\000\015\000\024\000\000\000\
\\014\000\082\000\015\000\024\000\000\000\
\\014\000\083\000\015\000\024\000\000\000\
\\013\000\084\000\014\000\025\000\015\000\024\000\000\000\
...
\\000\000\
\\011\000\039\000\013\000\026\000\014\000\025\000\015\000\024\000\
\\017\000\087\000\018\000\035\000\000\000\
\\011\000\039\000\013\000\026\000\014\000\025\000\015\000\024\000\
\\016\000\088\000\017\000\036\000\018\000\035\000\000\000\
\\004\000\089\000\000\000\
\\011\000\090\000\013\000\026\000\014\000\025\000\015\000\024\000\000\000\
...
\\000\000\
\\000\000\
\\008\000\097\000\009\000\050\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
|  ( 4, ( rest671)) => let val  result = MlyValue.DS (fn _ => (
LEAF(".")))
...
|  ( 9, ( rest671)) => let val  result = MlyValue.VLE (fn _ => (
LEAF(".")))
 in ( LrTable.NT 6, ( result, defaultPos, defaultPos), rest671)
end
|  ( 10, ( ( _, ( _, _, RCPAREN1right)) :: ( _, ( _, LCPAREN1left, _))
 :: rest671)) => let val  result = MlyValue.CS (fn _ => (LEAF(".")))
...
|  ( 13, ( rest671)) => let val  result = MlyValue.CO (fn _ => (
LEAF(".")))
...
READ1left, _)) :: rest671)) => let val  result = MlyValue.C (fn _ =>
 ...
 in (NODE("READ",LEAF(lookup ID) , LEAF(".")))
end)
...
result = MlyValue.C (fn _ => let val  (BEXP as BEXP1) = BEXP1 ()
 val  (CS as CS1) = CS1 ()
 val  CS2 = CS2 ()
 in (NODE("IF",BEXP,NODE("IF CS",CS1,CS2)))
end)
...
BEXP as BEXP1) = BEXP1 ()
 val  (CS as CS1) = CS1 ()
 in (NODE("WHILE",BEXP,NODE("DO",CS,LEAF("."))))
end)
...
|  ( 47, ( ( _, ( MlyValue.NUM NUM1, _, NUM1right)) :: ( _, ( _, 
...
|  ( 48, ( ( _, ( MlyValue.NUM NUM1, NUM1left, NUM1right)) :: rest671)
...
|  ( 49, ( ( _, ( MlyValue.NUM NUM1, _, NUM1right)) :: ( _, ( _, 
...
ParserData.MlyValue.VOID,p1,p2))
fun ENDIF (p1,p2) = Token.TOKEN (ParserData.LrTable.T 23,(
ParserData.MlyValue.VOID,p1,p2))
fun WHILE (p1,p2) = Token.TOKEN (ParserData.LrTable.T 24,(
ParserData.MlyValue.VOID,p1,p2))
fun DO (p1,p2) = Token.TOKEN (ParserData.LrTable.T 25,(
ParserData.MlyValue.VOID,p1,p2))
fun ENDWH (p1,p2) = Token.TOKEN (ParserData.LrTable.T 26,(
ParserData.MlyValue.VOID,p1,p2))
...
ParserData.MlyValue.VOID,p1,p2))
fun TT (p1,p2) = Token.TOKEN (ParserData.LrTable.T 30,(
ParserData.MlyValue.VOID,p1,p2))
fun FF (p1,p2) = Token.TOKEN (ParserData.LrTable.T 31,(
ParserData.MlyValue.VOID,p1,p2))
fun NEG (p1,p2) = Token.TOKEN (ParserData.LrTable.T 32,(
ParserData.MlyValue.VOID,p1,p2))
